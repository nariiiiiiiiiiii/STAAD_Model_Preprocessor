...
- [`superpowers/plans/2026-09-12-user-selected-save-destinations.md`](superpowers/plans/2026-09-12-user-selected-save-destinations.md) — STRICT-approved First Save/Save As implementation, 58-test evidence, and owner manual acceptance gate.
