...
The official `Noncommercial Organizations` section expressly permits use by charitable, educational, public research, public safety/health, environmental-protection, and government organizations regardless of funding source or obligations resulting from funding. This may be broader than a blanket prohibition on every paid or income-generating use. Preserve the official wording as requested, disclose this exception in the README, and obtain owner confirmation before commit/push.
